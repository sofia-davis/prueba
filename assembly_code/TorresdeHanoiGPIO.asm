...
main:
	...
	addi s3, s3, 0x0080
	lui a2, 0x10010       # dirección alta de la torre A (10010000)
	addi a2, a2, 0x0000   # ajuste bajo
	#GPIO
	lui s10, 0x10010      # direccion GPIO Leds
	addi s10, s10, 0x0024
	lui s11, 0x10010      # direccion GPIO Switches
	addi s11, s11, 0x0028
	# constantes
...
llenar_memoria_en_ceros:
	beq t5, t6, emepzar_movimientos
	addi t5, t5, 4
	sw zero, 0(t5)
	jal zero, llenar_memoria_en_ceros
	
emepzar_movimientos:
	sw t0, 0(s11)
	addi s1, a2, 0
	lw t5, 0(s11)
	bne t5, t0, emepzar_movimientos
